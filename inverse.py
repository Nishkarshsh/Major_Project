...
if __name__ == '__main__':
    ...
    while True:
        ...
        x = 10#float(input("Enter x-coordinate "))
        y = 10#float(input("Enter y-coordinate "))
        z = 10#float(input("Enter z-coordinate "))
        config = 'up'#input("Set end-effector configuration ")
